...
namespace GraphQl.Common.Database
{
    public class MovieDbContext : DbContext
    {
        ...
        {
            //MasterData masterData = XmlFileHandler.ReadXmlInput<MasterData>(
            //    @"D:\git\GraphQl - EF - Dotnet - Example\GraphQl.Common\SchemaData\master\Master(1).xml");
            ...
            //masterData.Locations.Add(locationType);

            //modelBuilder.Entity<MasterData>().HasData(masterData);
